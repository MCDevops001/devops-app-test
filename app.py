...
def analyze_resumes(openai_api_key, job_description, uploaded_files, use_llm_report=True):
...
if st.button("Analyze"):
    if not api_key:
        ...
        # Run analysis
        try:
            df, report = analyze_resumes(api_key, job_description, uploaded_files, use_llm_report=use_llm)
